...
class AdminUsersWorkerClient {
  ...
  Future<AdminUserRoleUpdateResult> updateUserRole({
    required String uid,
    required String role,
    required String bearerToken,
    required String traceId,
  }) async {
    final path = '$_baseUrl/admin/users/$uid/role';
    ...
    try {
      _logger.debug(
        'Sending worker user role update request.',
        context: {'traceId': traceId, 'uid': uid, 'role': role, 'path': path},
      );
      ...
      return AdminUserRoleUpdateResult.fromJson(data);
